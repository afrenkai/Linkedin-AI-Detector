...
#SBATCH -n 32
#SBATCH --mem=64g
#SBATCH -J "test for training slop linkedin llm"
#SBATCH -p long
#SBATCH -t 24:00:00
#SBATCH --gres=gpu:4
#SBATCH -C "H200|H100|A100-80G"
...
run_training_test_init() {
  ...
  local eval_every=${14:-5}
  local save_every=${15:-10}
  ...
  log " Running Optimizer Warmup Steps: $warmup_steps"
  log " Context Length: $block_size"
  log " Gradient Accumulation: $grad_accum"
  log " Optimizer Weight Decay: $optim_weight_decay"
